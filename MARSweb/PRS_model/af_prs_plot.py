...
data = pd.read_csv("/Data/ktg/cblab_webserver/NICER-master/PRS_database/consent_1_835_af.csv")
data = data.dropna()
...
def main():
    ...
    parser.add_argument('--output', type=str, default='af_plot.png', help='Output file name for the plot')
    ...
    sns.kdeplot(data=data, x='PRSice2', hue='AF', common_norm=False)
