...
data = pd.read_csv("/Data/ktg/cblab_webserver/NICER-master/PRS_database/consent_1_835_str.csv")
data = data.dropna()
...
def main():
    ...
    parser.add_argument('--output', type=str, default='str_plot.png', help='Output file name for the plot')
    ...
    sns.kdeplot(data=data, x='PRSice2', hue='STR', common_norm=False)
    ...
    total_case = data[data['STR'] == 1].shape[0]
    cases_above_value = data[(data['STR']==1)&(data['PRSice2'] >= value)].shape[0]
