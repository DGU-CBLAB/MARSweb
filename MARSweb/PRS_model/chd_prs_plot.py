...
data = pd.read_csv("/Data/ktg/cblab_webserver/NICER-master/PRS_database/consent_1_835_chd.csv")
data = data.dropna()
...
def main():
    ...
    parser.add_argument('--output', type=str, default='chd_plot.png', help='Output file name for the plot')
    ...
    sns.kdeplot(data=data, x='PRSice2', hue='CHD', common_norm=False)
    ...
    total_case = data[data['CHD'] == 1].shape[0]
    cases_above_value = data[(data['CHD']==1)&(data['PRSice2'] >= value)].shape[0]
