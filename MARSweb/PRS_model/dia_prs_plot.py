...
data = pd.read_csv("/Data/ktg/cblab_webserver/NICER-master/PRS_database/consent_1_835_dia.csv")
data = data.dropna()
...
def main():
    ...
    parser.add_argument('--output', type=str, default='dia_plot.png', help='Output file name for the plot')
    ...
    sns.kdeplot(data=data, x='PRSice2', hue='DIA', common_norm=False)
    ...
    total_case = data[data['DIA'] == 1].shape[0]
    cases_above_value = data[(data['DIA']==1)&(data['PRSice2'] >= value)].shape[0]
