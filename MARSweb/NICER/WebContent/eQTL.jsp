...
<body style="background:#fff;">
	...
	<section class="ftco-cover"
		...
		<div class="container" style="background:#f5f5f5;">
			<div class="col-md-7">
				<h1 data-aos="fade-up" data-aos-delay="500">Upload files to use eQTL Map</h1> <!--  class="ftco-heading mb-3"  -->
        			<h2 data-aos="fade-up"  data-aos-delay="600">For using eQTL Map, you need to upload SNP_position file, phenotype_position file and p-value file.</h2>    <!-- class="h5 ftco-subheading mb-5" -->
			</div>
					...
					<div class="container">
						<div class="row block-9">
							<div class="col-md-6 pr-md-5" style="background-image: none;">
								...
								for="tab1" data-tab="tab-1" style="padding: 15px 18px">NICER</label> 
								<input id="tab2" type="radio" name="tabs" value="type2"
								style="display: none"> <label for="tab2"
								data-tab="tab-2" style="padding: 15px 18px">MARSweb</label><br> 
							
							<div id="tab-1" class="tab-content current">
								<form action="eQTL" method="post" enctype="multipart/form-data">
						...
						<div id="tab-1-1" class="tab-content current" style="background-image: none;height:284px; width:480px; overflow:auto; white-space:nowrap;"> 
					  	...
					  	<p><font color="black" size=5>--------- SNP Position file --------- </font><br>
					  	<font color="black">
					  	There is three fileds per variants (no headline) <br>
					  	rs_id chr_number poistion <br>
					  	ex) 5 variants  <br> 
					  	rs1 chr1 1 <br>
					  	rs2 chr3 2 <br>
					  	rs13 chr12 3 <br>
					  	rs16 chr13 4 <br>
					  	rs22 chr15 5 <br>
						** Position refers to the order in the given data, not the actual position number. **<br>
					  	</font>
					  	<font color="black" size=5>--------- gene Position Data --------- </font><br>
					  	<font color="black">
					  	There is three fileds per gene (no headline) <br>
						gene_id chr_number poistion <br>
					  	ex) 3 gene <br>
					  	gene1 chr1 1 <br>
					  	gene2 chr5 2 <br>
					  	gene10 chr10 3 <br>
						** Position refers to the order in the given data, not the actual position number. **<br>
						...
						<font color="black" size=5>--------- P-value file --------- </font><br>
					  	<font color="black">
						** Please upload the results obtained from running NICE **<br>
					  	</font>
					  	</p>
						</div>
